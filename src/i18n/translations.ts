...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    hero: {
      ...
      description: 'Motivated Java Full Stack Developer with a foundation in Java, Spring Boot, HTML, CSS, JavaScript, and SQL. Skilled in developing responsive web applications and working with both front-end and back-end technologies.',
  ...
  ta: {
    ...
    hero: {
      ...
      title: 'சாஃப்ட்வேர் இன்ஜினியர் | ஃபுல் ஸ்டாக் டெவலப்பர்',
      description: 'Java, Spring Boot, HTML, CSS, JavaScript மற்றும் SQL ஆகியவற்றில் அடித்தளம் கொண்ட உந்துதல் மிக்க Java ஃபுல் ஸ்டாக் டெவலப்பர். பதிலளிக்கக்கூடிய வலை பயன்பாடுகளை உருவாக்குவதில் மற்றும் முன் மற்றும் பின்புல தொழில்நுட்பங்களுடன் பணிபுரிவதில் திறமையானவர்.',
  ...
  hi: {
    ...
    hero: {
      ...
      name: 'तमिलसेल्वन पी',
      title: 'सॉफ्टवेयर इंजीनियर | फुल स्टैक डेवलपर',
      description: 'Java, Spring Boot, HTML, CSS, JavaScript और SQL की नींव वाला मेहनती Java फुल स्टैक डेवलपर। रेस्पॉन्सिव वेब एप्लीकेशन बनाने और फ्रंटएंड व बैकएंड तकनीकों के साथ काम करने में कुशल।',
